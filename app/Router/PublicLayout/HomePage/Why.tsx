export default function WhyVoice() {
    return (
        <section className="w-full min-h-[50vh] bg-gradient-to-r from-[#7A23FE] to-[#18D1F8] ">
            ...
            <div className=" gap-y-7 w-full md:w-[40%] lg:w-[80%] lg:justify-center xl:w-full min-h-[50%] flex flex-col xl:flex-row gap-x-5 justify-center items-center">
                <div className="md:w-full md:h-[45vh] xl:w-[20vw] xl:h-[50vh] bg-white rounded-2xl flex flex-col overflow-hidden">
                    <div className="w-full min-h-[25%] flex flex-col bg-black rounded-t-2xl px-3 justify-center">
                        ...
                        <p className="text-[2vh] text-white">
                            No matter your setup—built-in noise suppression and voice enhancement.
                        </p>
                    </div>
                    <div className="w-full h-[75%] bg-red-500 rounded-b-2xl">
                        <img
                            src="https://www.voicemod.net/new/wp-content/uploads/2025/03/Group-1000004095.png"
                            alt=""
                ...
                <div className="w-full xl:w-[45vw] h-[50vh] bg-white rounded-2xl flex flex-col overflow-hidden">
                    ...
                    <div className="w-full h-[75%] bg-red-500 rounded-b-2xl">
                        <img
                            src="https://www.voicemod.net/new/wp-content/uploads/2025/03/Group-1000004096.png"
                            alt=""
                            className="w-full h-full object-cover"
                        />
                    </div>
                 ...
                 <div className="md:w-full md:h-[45vh] xl:w-[20vw] xl:h-[50vh] bg-white rounded-2xl flex flex-col overflow-hidden">
                    ...
                    <div className="w-full h-[75%] bg-red-500 rounded-b-2xl">
                        <img
                            src="https://www.voicemod.net/new/wp-content/uploads/2024/04/small-keybinds.png"
                            alt=""
                            className="w-full h-full object-cover"
                        />
                    </div>
            ...
            <div className="gap-y-7 w-full md:w-[40%] lg:w-[80%] lg:justify-center xl:w-full min-h-[50%] flex flex-col xl:flex-row gap-x-5 justify-center items-center">
                ...
                <div className="w-full h-[50vh] bg-white rounded-2xl flex flex-col overflow-hidden">
                    ...
                    <div className="w-full h-[75%] bg-red-500 rounded-b-2xl ">
                        <img
                            src="https://www.voicemod.net/new/wp-content/uploads/2025/03/Group-1000004092.png"
                            alt=""
                            className="w-full h-full object-cover"
                        />
                    </div>
                ...
                <div className="w-full h-[50vh] bg-white rounded-2xl flex flex-col overflow-hidden">
                    ...
                    <div className="w-full h-[75%] bg-red-500 rounded-b-2xl">
                        <img
                            src="https://www.voicemod.net/new/wp-content/uploads/2024/04/voicemod-go.png"
                            alt=""
                            className="w-full h-full object-cover"
                        />
                    </div>
        ...
        <div className="w-full overflow-hidden whitespace-nowrap bg-gradient-to-r from-purple-400 via-green-300 to-orange-400">
        <div className="inline-flex animate-marquee text-[3vh]">
          <h1 className="text-black font-extrabold mx-4">SUPERCHARGE YOUR VOICE -</h1>
          <h1 className="text-black font-extrabold mx-4">SUPERCHARGE YOUR VOICE -</h1>
          <h1 className="text-black font-extrabold mx-4">SUPERCHARGE YOUR VOICE -</h1>
          <h1 className="text-black font-extrabold mx-4">SUPERCHARGE YOUR VOICE -</h1>
          <h1 className="text-black font-extrabold mx-4">SUPERCHARGE YOUR VOICE -</h1>
